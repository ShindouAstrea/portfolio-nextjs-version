        ...
        <div className="w-full lg:h-screen p-2">
            <div className=" max-w-[1240px] mx-auto flex flex-col justify-center h-full text-center">
                ...
                <p className='my-4 p-5 text-lg '>Con qué he trabajado?</p>
                    <div className="grid md:grid-cols-2 my-5 lg:grid-cols-4 gap-8 min-[300px]:m-4">
                    {iconsArray.map((icon)=>
                      <div className="p-6 shadow-xl rounded-xl hover:scale-105 ease-in duration-100 bg-[#1A1F36]"key={icon.key}>
