...
export default  function Main(){
    ...
    return(
        <div  className=' w-full lg:h-screen p-2 ' onContextMenu={handlerContext}>
            <div className='max-w-[1240px] mx-auto flex flex-col justify-center h-full mt-[8rem] text-justify'>
                <div className='flex flex-col text-justify items-center alig gap-8'>
